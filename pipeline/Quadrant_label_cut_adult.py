...
mask_path = r'/media/ps/lys_ssd/Project/Project_Multi_Child_TMI/data_GCN/adult_multi_center/Center3/label_company'
resizer_path = r'/media/ps/lys_ssd/Project/Project_Multi_Child_TMI/data_GCN/adult_multi_center/Center3/predict/resizer_npy'

predict_path = r'/media/ps/lys_ssd/Project/Project_Multi_Child_TMI/data_GCN/adult_multi_center/Center3/predict/Quadrant_tooth_results'
save_quadrant_path = r'/media/ps/lys_ssd/Project/Project_Multi_Child_TMI/data_GCN/adult_multi_center/Center3/predict/gt'
...
for case in [ i for i in os.listdir(resizer_path) if i.replace('.npy','.nii.gz') in os.listdir(mask_path)]:
    ...
    for idx,(key,value) in enumerate(dict(result).items()):
        ...
        quadrant_gt_array[quadrant_gt_array == 99] = 9


        print(np.unique(quadrant_gt_array))
